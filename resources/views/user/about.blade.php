...
<body>
    ...
    <div class="frame-3">
        <h2>Our Partner</h2>
        <div class="partner">
            <img class="partner-img" src="{{ asset('pict/mi.png') }}" alt="mi" width="100px" height="70px">
            <img class="partner-img" src="{{ asset('pict/apple.png') }}" alt="apple" width="100px" height="80px">
            <img class="partner-img" src="{{ asset('pict/samsung.png') }}" alt="samsung" width="270px" height="50px">
            <img class="partner-img" src="{{ asset('pict/huawei.png') }}" alt="huawei" width="100px" height="70px">
            <img class="partner-img" src="{{ asset('pict/asus.png') }}" alt="asus" width="200px" height="50px">
            <img class="partner-img" src="{{ asset('pict/lenovo.png') }}" alt="lenovo" width="200px" height="60px">
        </div>
    </div>
    ...
    <div class="frame-4">
        ...
        <div class="team">
            <div class="box">
                <img src="{{ asset('pict/larissa.jpg') }}" alt="me">
                <h3>Larissa Paulina Christmas Hutauruk</h3>
                <p>Front End Dev</p>
            </div>
            <div class="box">
                <img src="{{ asset('pict/rey.jpg') }}" alt="rey">
